 ...
 */
public class ModelDumperHook extends Hook implements InjectionHook {
    private ClassGen cG;
    ...
    public ModelDumperHook(HookHandler hookHandler, ClassGen cG, Method method, int position, ClassGen modelCG, int aloadIndex, String fieldName) {
        this.cG = cG;
        this.method = method;
    ...
    public void applyXMLForInjection(Document doc) {
        ...
        taskNode.addContent(new Element("type").setText("ModelDumper"));
