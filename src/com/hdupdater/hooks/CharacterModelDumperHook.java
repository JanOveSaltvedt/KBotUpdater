 ...
 */
public class CharacterModelDumperHook extends Hook implements InjectionHook {
    private ClassGen cG;
    ...
    public CharacterModelDumperHook(HookHandler hookHandler, ClassGen cG, Method method, int position, ClassGen modelCG, int aloadIndex) {
        this.cG = cG;
        this.method = method;
    ...
    public void applyXMLForInjection(Document doc) {
        ...
        taskNode.addContent(new Element("type").setText("CharacterModelDumper"));
