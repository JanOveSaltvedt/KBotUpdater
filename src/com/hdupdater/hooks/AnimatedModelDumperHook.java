 ...
 */
public class AnimatedModelDumperHook extends Hook implements InjectionHook {
    private ClassGen cG;
    private Method method;

    public AnimatedModelDumperHook(HookHandler hookHandler, ClassGen cG, Method method) {
        this.cG = cG;
        this.method = method;
    ...
    public void applyXMLForInjection(Document doc) {
        ...
        taskNode.addContent(new Element("type").setText("AnimatedModelDumper"));
