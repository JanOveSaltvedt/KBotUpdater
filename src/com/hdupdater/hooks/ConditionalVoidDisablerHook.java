 ...
 */
public class ConditionalVoidDisablerHook extends Hook implements InjectionHook {
    private ClassGen cG;
    private Method method;
    private String condMethodName;

    public ConditionalVoidDisablerHook(HookHandler hookHandler, ClassGen cG, Method method, String condMethodName) {
        this.cG = cG;
        this.method = method;
        this.condMethodName = condMethodName;
    ...
    public void applyXMLForInjection(Document doc) {
        ...
        taskNode.addContent(new Element("type").setText("CondVoidDisabler"));
        ...
        dataNode.addContent(new Element("condMethodName").setText(""+condMethodName));
