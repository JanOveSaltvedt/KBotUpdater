 ...
 * Time: 17:42:09
 */
public class LongShiftDeobber extends AbstractDeobber{
    public void run() {
        int fixedShifts = 0;
        for(ClassGen cG: classes){
            ...
            for(Method m: cG.getMethods()){
                ...
                for(Iterator<InstructionHandle[]> iterator = instructionFinder.search("PushInstruction ((lshl)|(lshr))"); iterator.hasNext();){
